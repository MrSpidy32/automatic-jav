...
<div class="header">
  <div class="header-inner">
    ...
    <div class="search-box">
      <input id="filter" placeholder="Search by code..." autocomplete="off" aria-label="Search videos">
    </div>
...
<div id="miniPlayer">
  <button id="miniClose" aria-label="Close mini player">&times;</button>
